...
namespace MathPaper
{
    public partial class Form1 : Form
    {
        ...
        private void textBox7_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!int.TryParse(textBox7.Text, out num7))
            {
                if (textBox7.Text == "")
                    MessageBox.Show("ERROR! Complete all!");
                else
        ...
        private void textBox8_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!int.TryParse(textBox8.Text, out num8))
            {
                if (textBox8.Text == "")
                    MessageBox.Show("ERROR! Complete all!");
                else
        ...
        private void textBox10_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!int.TryParse(textBox10.Text, out num10))
            {
                if (textBox10.Text == "")
                    MessageBox.Show("ERROR! Complete all!");
                else
        ...
        private void textBox11_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (!int.TryParse(textBox11.Text, out num11))
            {
                if (textBox11.Text == "")
                    MessageBox.Show("ERROR! Complete all!");
                else
